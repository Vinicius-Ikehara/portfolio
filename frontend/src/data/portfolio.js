...
export const profile = {
  ...
  title: "AI Developer",
  bio: "AI Developer focused on taking LLM applications from prototype to production. I build AI systems end to end — backend, frontend, and the model layer — with observability built in from the start, instrumenting cost, latency, confidence, and model comparison so architectural decisions rest on data instead of intuition. I work agent-first, using Claude Code with custom skills and subagents to plan, implement, and review, and I design RAG architectures that connect LLMs to real organizational data with accuracy and reliability.",
...
export const experiences = [
  {
    ...
    company: "domy",
    description: "Building an AI-powered risk analysis application end to end — backend, frontend, and the AI layer. Instrumented the full LLM pipeline with Langfuse for production observability, tracking cost per request, model confidence, latency, and side-by-side model comparison to decide which models actually earn their place in production. Development runs agent-first with Claude Code, using custom skills, subagents, and slash commands to plan, implement, and review changes across the stack. Also built an internal RAG and vector search system that lets employees instantly retrieve information from documents, PDFs, and structured database content.",
    technologies: ["Python", "FastAPI", "Vue.js", "Claude Code", "Langfuse", "LLM Observability", "Agno", "RAG", "Vector Databases", "Apache Airflow"],
    start_date: "2025-08",
    end_date: null,
    current: true
  },
...
export const projects = [
  ...
  },
  {
    ...
    image_url: "/images/accidents.jpg",
  ...
  },
  {
    ...
    image_url: "/images/ai-agent-video.jpeg",
